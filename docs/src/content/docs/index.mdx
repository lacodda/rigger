...
Stage 0: the repository, the release conveyor and the roadmap exist. The first command surface arrives with v0.1.0. See the [roadmap](https://github.com/lacodda/rigger#status).
